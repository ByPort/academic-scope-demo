...
class TestDuckDBHook:
    ...
    def test_hook_initialization_default(self, mock_airflow_connections: dict) -> None:
    ...
    def test_hook_initialization_custom(self, mock_airflow_connections: dict) -> None:
    ...
    def test_get_conn(self, mock_airflow_connections: dict) -> None:
    ...
    def test_connection_error_handling(self, mock_airflow_connections: dict) -> None:
